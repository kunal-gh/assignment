...
class LLMService:
    ...
    def generate_explanation(
        ...
        if not self._available:
            return self._generate_fallback_explanation(
                candidate_name, rank, semantic_score, skill_score, hybrid_score, matched_skills, missing_skills, job_title
            )
        ...
        try:
            ...
            if response:
                ...
                return (
                    content.strip()
                    if content
                    else self._generate_fallback_explanation(
                        candidate_name,
                        rank,
                        semantic_score,
                        skill_score,
    ...
    def _generate_fallback_explanation(
        ...
        if missing_skills:
            ...
            explanation_parts.append(f"Development opportunities exist in {', '.join(top_missing)}.")
