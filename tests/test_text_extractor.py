...
class TestTextExtractor:
    ...
    def test_pymupdf_extraction_normal_pdf(self, mock_fitz_open):
        ...
        mock_doc = MagicMock()
        mock_page = MagicMock()
        mock_page.get_text.return_value = "This is a normal PDF with plenty of text content that should not trigger OCR warnings."
    ...
    def test_pdfplumber_extraction_with_tables(self, mock_pdfplumber_open):
        ...
        mock_page.extract_tables.return_value = [
            [["Name", "Position"], ["John Doe", "Engineer"], ["Jane Smith", "Manager"]]
        ]
