...
class TestRankingEngine:
    ...
    def test_calculate_hybrid_score_no_embeddings(self):
        ...
        job_desc = JobDescription(
            title="ML Engineer", description="Looking for Python and ML skills", required_skills=["Python", "Machine Learning"]
        )
    ...
    def test_rank_candidates_empty_list(self):
        ...
        job_desc = JobDescription(title="Test Job", description="Test description", required_skills=["Python"])
    ...
    def test_rank_candidates_single_candidate(self):
        ...
        job_desc = JobDescription(title="Python Developer", description="Python programming", required_skills=["Python"])
    ...
    def test_explain_ranking(self):
        ...
        job_desc = JobDescription(
            title="ML Engineer", description="Python and ML required", required_skills=["Python", "Machine Learning"]
        )
...
def test_ranking_with_mock_embeddings(mock_embedding_generator):
    ...
    engine = RankingEngine(semantic_weight=0.7, skill_weight=0.3, embedding_generator=mock_embedding_generator)
