...
class TestSkillMatcher:
    ...
    def test_calculate_skill_match_weighted_scoring(self):
        ...
        score_equal = self.matcher.calculate_skill_match(
            resume_skills, required_skills, preferred_skills, required_weight=0.5, preferred_weight=0.5
        )
        ...
        score_req_heavy = self.matcher.calculate_skill_match(
            resume_skills2, required_skills2, preferred_skills2, required_weight=0.9, preferred_weight=0.1
        )
        score_pref_heavy = self.matcher.calculate_skill_match(
            resume_skills2, required_skills2, preferred_skills2, required_weight=0.1, preferred_weight=0.9
        )
